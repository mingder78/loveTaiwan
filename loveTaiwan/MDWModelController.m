...
@interface MDWModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation MDWModelController
...
{   
    ...
    MDWDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"MDWDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(MDWDataViewController *)viewController];
